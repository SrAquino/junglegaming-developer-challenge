...
export default function App() {
  ...
  if (screen === 'game') return <GameCanvas audio={audio} audioSettings={audioSettings} configuration={configuration} gameOptions={options} onExit={() => setScreen('menu')} onFinished={finish} onSaveOptions={applyOptions} />
